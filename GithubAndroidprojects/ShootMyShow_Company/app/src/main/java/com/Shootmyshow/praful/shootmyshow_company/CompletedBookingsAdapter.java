...
public class CompletedBookingsAdapter extends BaseAdapter {
    ...
    public CompletedBookingsAdapter(Activity activity, List<com.Shootmyshow.praful.shootmyshow_company.Model.Bookings> bookings) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        FirebaseDatabase.getInstance().getReference(Common.coustomers_table)
                .child(txtcustomerId.getText().toString())
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        removebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("CompletedBookings").child(Common.userid).child(Bookings.get(position).getId()).removeValue();
