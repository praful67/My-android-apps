...
public class Pasttimeoffsadapter extends BaseAdapter {
    List<Timeoff> timeoffList;
    Activity activity;
    ArrayList<Timeoff> arrayList;

    public Pasttimeoffsadapter(List<Timeoff> timeoffList, Activity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        view = layoutInflater.inflate(R.layout.pasttimeoffitem, null);
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Do you want remove this past time offs ? ")
