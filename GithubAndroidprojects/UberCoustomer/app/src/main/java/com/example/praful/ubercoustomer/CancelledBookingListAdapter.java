...
public class CancelledBookingListAdapter extends BaseAdapter {
    ...
    public CancelledBookingListAdapter(Activity activity, List<com.example.praful.ubercoustomer.Model.Bookings> bookings) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.cancelledbookingitem, null);
        ...
        final ImageView removebtn = (ImageView) itemView.findViewById(R.id.cancelAdvancebooking);

        removebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                databaseReference.child("cancelledcustomerBookings").child(Common.userid).child(Bookings.get(position).getId()).removeValue();
