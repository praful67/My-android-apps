...
public class Availablecompanydetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_availablecompanydetails);
        ...
        btnAdvanceBookthisCompany.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Availablecompanydetails.this, CallCompanyforAdvanceBooking.class);
    ...
    private void collectcomments(Map<String, Object> value) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Availablecompanydetails.this, android.R.layout.simple_list_item_1, comments);
